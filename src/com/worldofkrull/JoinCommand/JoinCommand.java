...
public class JoinCommand extends JavaPlugin {
	...
	public void onEnable() {
		...
		System.out.println("[" + pdfFile.getName() + "] Version " + pdfFile.getVersion() + " by Kohle enabled!");
		...
		//This is all the info for DCP (auto updater)
		String name = this.getDescription().getName();

		String version = this.getDescription().getVersion();

		String checklocation = "http://penguinzoom.com/DCP/web/check.php";

		String downloadlocation = "http://penguinzoom.com/DCP/web/dl.php";
